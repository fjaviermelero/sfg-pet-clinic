...
* The original package name 'fjaviermelero.springframework.sfg-pet-clinic' is invalid and this project uses 'fjaviermelero.springframework.sfgpetclinic' instead.
